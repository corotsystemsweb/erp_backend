...
public class TransactionFilter implements Filter {
    ...
    public void doFilter(final ServletRequest request,
        ...
        // ✅ Allow Swagger + Public APIs (IMPORTANT FIX)
        if (
                path.startsWith("/swagger-ui") ||
                        ...
                        path.equals("/api/verifyOtp") ||
                        path.equals("/api/reset/password") ||
                        path.equals("/api/password/verify/otp") ||
                        path.equals("/api/resend/otp") ||
                        path.equals("/api/resendOtp/registration") ||
